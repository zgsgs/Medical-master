// pages/Personal/exchange/exchangeinfos.js
...
Page({
  ...
  onCancelOrders:function(res){
    var OrderNumber = res.target.dataset.ordernumber
    CancelOrders(this, appInstance, OrderNumber)
...
function CancelOrders(that, appInstance, OrderNumber){
  wx.request({
    url: 'https://xcx.yzw0525.com/api/cancelOrders',
    data: {
      OrderNumber: OrderNumber
    },
    method: "POST",
